...
/**
 * Base class that represents a row from the 'champion' table.
 *
 * 
 *
* @package    propel.generator.Kolter.DataBase.Models.Base
*/
abstract class Champion implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Kolter\\DataBase\\Models\\Map\\ChampionTableMap';
    ...
    /**
     * Initializes internal state of Kolter\DataBase\Models\Base\Champion object.
     */
    ...
    /**
     * Compares this with another <code>Champion</code> instance.  If
     * <code>obj</code> is an instance of <code>Champion</code>, delegates to
     * <code>equals(Champion)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Champion The current object, for fluid interface
     */
     ...
     * @return $this|\Kolter\DataBase\Models\Champion The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ChampionTableMap::COL_ID] = true;
        }
    ...
    public function setWinratio($v)
    {
        ...
        if ($this->winratio !== $v) {
            $this->winratio = $v;
            $this->modifiedColumns[ChampionTableMap::COL_WINRATIO] = true;
        }
    ...
    public function setTotalsessionsplayed($v)
    {
        ...
        if ($this->totalsessionsplayed !== $v) {
            ...
            $this->modifiedColumns[ChampionTableMap::COL_TOTALSESSIONSPLAYED] = true;
        }
    ...
    public function setTotalsessionswon($v)
    {
        ...
        if ($this->totalsessionswon !== $v) {
            ...
            $this->modifiedColumns[ChampionTableMap::COL_TOTALSESSIONSWON] = true;
        }
    ...
    public function setTotalsessionslost($v)
    {
        ...
        if ($this->totalsessionslost !== $v) {
            ...
            $this->modifiedColumns[ChampionTableMap::COL_TOTALSESSIONSLOST] = true;
        }
    ...
    public function setTotalchampionkills($v)
    {
        ...
        if ($this->totalchampionkills !== $v) {
            ...
            $this->modifiedColumns[ChampionTableMap::COL_TOTALCHAMPIONKILLS] = true;
        }
    ...
    public function setTotalassists($v)
    {
        ...
        if ($this->totalassists !== $v) {
            $this->totalassists = $v;
            $this->modifiedColumns[ChampionTableMap::COL_TOTALASSISTS] = true;
        }
    ...
    public function setTotaldeathspersession($v)
    {
        ...
        if ($this->totaldeathspersession !== $v) {
            ...
            $this->modifiedColumns[ChampionTableMap::COL_TOTALDEATHSPERSESSION] = true;
        }
    ...
    public function setTotalgoldearned($v)
    {
        ...
        if ($this->totalgoldearned !== $v) {
            ...
            $this->modifiedColumns[ChampionTableMap::COL_TOTALGOLDEARNED] = true;
        }
    ...
    public function setTotaldamagedealt($v)
    {
        ...
        if ($this->totaldamagedealt !== $v) {
            ...
            $this->modifiedColumns[ChampionTableMap::COL_TOTALDAMAGEDEALT] = true;
        }
    ...
    public function setTotaldamagetaken($v)
    {
        ...
        if ($this->totaldamagetaken !== $v) {
            ...
            $this->modifiedColumns[ChampionTableMap::COL_TOTALDAMAGETAKEN] = true;
        }
    ...
    public function setPoints($v)
    {
        ...
        if ($this->points !== $v) {
            $this->points = $v;
            $this->modifiedColumns[ChampionTableMap::COL_POINTS] = true;
        }
    ...
    public function setUpdateAt($v)
    {
        ...
        if ($this->update_at !== null || $dt !== null) {
            if ($this->update_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->update_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ChampionTableMap::COL_UPDATE_AT] = true;
            }
    ...
    public function setEntries($v)
    {
        ...
        if ($this->entries !== $v) {
            $this->entries = $v;
            $this->modifiedColumns[ChampionTableMap::COL_ENTRIES] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ChampionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ChampionTableMap::translateFieldName('Winratio', TableMap::TYPE_PHPNAME, $indexType)];
            $this->winratio = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ChampionTableMap::translateFieldName('Totalsessionsplayed', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalsessionsplayed = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ChampionTableMap::translateFieldName('Totalsessionswon', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalsessionswon = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ChampionTableMap::translateFieldName('Totalsessionslost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalsessionslost = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ChampionTableMap::translateFieldName('Totalchampionkills', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalchampionkills = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ChampionTableMap::translateFieldName('Totalassists', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalassists = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ChampionTableMap::translateFieldName('Totaldeathspersession', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totaldeathspersession = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ChampionTableMap::translateFieldName('Totalgoldearned', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalgoldearned = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ChampionTableMap::translateFieldName('Totaldamagedealt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totaldamagedealt = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ChampionTableMap::translateFieldName('Totaldamagetaken', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totaldamagetaken = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ChampionTableMap::translateFieldName('Points', TableMap::TYPE_PHPNAME, $indexType)];
            $this->points = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : ChampionTableMap::translateFieldName('UpdateAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->update_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : ChampionTableMap::translateFieldName('Entries', TableMap::TYPE_PHPNAME, $indexType)];
            $this->entries = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 14; // 14 = ChampionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Kolter\\DataBase\\Models\\Champion'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildChampionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Champion::setDeleted()
     * @see Champion::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildChampionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ChampionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ChampionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_WINRATIO)) {
            $modifiedColumns[':p' . $index++]  = 'winratio';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALSESSIONSPLAYED)) {
            $modifiedColumns[':p' . $index++]  = 'totalSessionsPlayed';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALSESSIONSWON)) {
            $modifiedColumns[':p' . $index++]  = 'totalSessionsWon';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALSESSIONSLOST)) {
            $modifiedColumns[':p' . $index++]  = 'totalSessionsLost';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALCHAMPIONKILLS)) {
            $modifiedColumns[':p' . $index++]  = 'totalChampionKills';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALASSISTS)) {
            $modifiedColumns[':p' . $index++]  = 'totalAssists';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALDEATHSPERSESSION)) {
            $modifiedColumns[':p' . $index++]  = 'totalDeathsPerSession';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALGOLDEARNED)) {
            $modifiedColumns[':p' . $index++]  = 'totalGoldEarned';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALDAMAGEDEALT)) {
            $modifiedColumns[':p' . $index++]  = 'totalDamageDealt';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALDAMAGETAKEN)) {
            $modifiedColumns[':p' . $index++]  = 'totalDamageTaken';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_POINTS)) {
            $modifiedColumns[':p' . $index++]  = 'points';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_UPDATE_AT)) {
            $modifiedColumns[':p' . $index++]  = 'update_at';
        }
        if ($this->isColumnModified(ChampionTableMap::COL_ENTRIES)) {
            $modifiedColumns[':p' . $index++]  = 'entries';
        }

        $sql = sprintf(
            'INSERT INTO champion (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'update_at':                        
                        ...
                        break;
                    case 'entries':                        
                        $stmt->bindValue($identifier, $this->entries, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = ChampionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Champion'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Champion'][$this->hashCode()] = true;
        $keys = ChampionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getWinratio(),
            $keys[2] => $this->getTotalsessionsplayed(),
            $keys[3] => $this->getTotalsessionswon(),
            $keys[4] => $this->getTotalsessionslost(),
            $keys[5] => $this->getTotalchampionkills(),
            $keys[6] => $this->getTotalassists(),
            $keys[7] => $this->getTotaldeathspersession(),
            $keys[8] => $this->getTotalgoldearned(),
            $keys[9] => $this->getTotaldamagedealt(),
            $keys[10] => $this->getTotaldamagetaken(),
            $keys[11] => $this->getPoints(),
            $keys[12] => $this->getUpdateAt(),
            $keys[13] => $this->getEntries(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Kolter\DataBase\Models\Champion
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setWinratio($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setTotalsessionsplayed($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setTotalsessionswon($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setTotalsessionslost($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setTotalchampionkills($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setTotalassists($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setTotaldeathspersession($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setTotalgoldearned($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setTotaldamagedealt($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setTotaldamagetaken($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setPoints($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setUpdateAt($arr[$keys[12]]);
        }
        if (array_key_exists($keys[13], $arr)) {
            $this->setEntries($arr[$keys[13]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Kolter\DataBase\Models\Champion The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ChampionTableMap::COL_ID)) {
            $criteria->add(ChampionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_WINRATIO)) {
            $criteria->add(ChampionTableMap::COL_WINRATIO, $this->winratio);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALSESSIONSPLAYED)) {
            $criteria->add(ChampionTableMap::COL_TOTALSESSIONSPLAYED, $this->totalsessionsplayed);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALSESSIONSWON)) {
            $criteria->add(ChampionTableMap::COL_TOTALSESSIONSWON, $this->totalsessionswon);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALSESSIONSLOST)) {
            $criteria->add(ChampionTableMap::COL_TOTALSESSIONSLOST, $this->totalsessionslost);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALCHAMPIONKILLS)) {
            $criteria->add(ChampionTableMap::COL_TOTALCHAMPIONKILLS, $this->totalchampionkills);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALASSISTS)) {
            $criteria->add(ChampionTableMap::COL_TOTALASSISTS, $this->totalassists);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALDEATHSPERSESSION)) {
            $criteria->add(ChampionTableMap::COL_TOTALDEATHSPERSESSION, $this->totaldeathspersession);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALGOLDEARNED)) {
            $criteria->add(ChampionTableMap::COL_TOTALGOLDEARNED, $this->totalgoldearned);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALDAMAGEDEALT)) {
            $criteria->add(ChampionTableMap::COL_TOTALDAMAGEDEALT, $this->totaldamagedealt);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_TOTALDAMAGETAKEN)) {
            $criteria->add(ChampionTableMap::COL_TOTALDAMAGETAKEN, $this->totaldamagetaken);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_POINTS)) {
            $criteria->add(ChampionTableMap::COL_POINTS, $this->points);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_UPDATE_AT)) {
            $criteria->add(ChampionTableMap::COL_UPDATE_AT, $this->update_at);
        }
        if ($this->isColumnModified(ChampionTableMap::COL_ENTRIES)) {
            $criteria->add(ChampionTableMap::COL_ENTRIES, $this->entries);
        }
    ...
    {
        $criteria = ChildChampionQuery::create();
        $criteria->add(ChampionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Kolter\DataBase\Models\Champion (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setEntries($this->getEntries());
        if ($makeNew) {
            $copyObj->setNew(true);
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Kolter\DataBase\Models\Champion Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ChampionTableMap::DEFAULT_STRING_FORMAT);
    }
